// EVOLVE-BLOCK START
config.add_listeners(elapsed,          {vulcan::listeners::global::RollingWindow(1)});
config.add_listeners(progress,         {vulcan::listeners::global::RollingWindow(1)});
config.add_listeners(has_spot,         {vulcan::listeners::global::RollingWindow(1)});
config.add_listeners(last_cluster_type, {vulcan::listeners::global::RollingWindow(1)});
